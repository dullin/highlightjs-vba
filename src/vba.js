...
export default function(hljs) {
    return {
      ...
      keywords: {
        keyword:
          '#if #else #const' +
          'Add ActiveWorkbook After alias and as base binary by byref byval ' + /* a-b */
          'call case compare const count custom database declare dim do ' + /* c-d */
          ...
          'select set Sheets static step stop sub ' + /* s */
          'text then to until wend while with Worksheets withevents', /* t-y */
        built_in:
